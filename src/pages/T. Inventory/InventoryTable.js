...
function createData(medicine, u_Synlab, u_Tecnoquimicas, u_Procaps, u_Quifarmed) {
  return { medicine, u_Synlab, u_Tecnoquimicas, u_Procaps, u_Quifarmed};
}
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.u_Quifarmed}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (

...
function createData(age, numberofpatients) {
...
const headCells = [
  ...
  { id: 'numberofpatients', numeric: true, disablePadding: false, label: 'Number of patients' },
];
          ...
          >
            ...
            <TableBody>
              {stableSort(rows, getComparator(order, orderBy))
                ...
                .map((row, index) => {
                  const isItemSelected = isSelected(row.age);
                  const labelId = `enhanced-table-checkbox-${index}`;

                  return (
                    <TableRow
                      hover
                      onClick={(event) => handleClick(event, row.age)}
                      role="checkbox"
                    ...
                    >
                      ...
                      <TableCell align="right">{row.numberofpatients}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
